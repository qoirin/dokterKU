...
public class DetailPembookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_pembooking);

        dbHelper = new DataHelper(this);

        SQLiteDatabase db = dbHelper.getReadableDatabase();
        cursor = db.rawQuery("select * from pembooking, dokter, booking where pembooking.nama = booking.nama AND dokter.merk = booking.merk AND pembooking.nama = '" + getIntent().getStringExtra("nama") + "'", null);
        cursor.moveToFirst();
    ...
    private void setupToolbar() {
        ...
        toolbar.setTitle("Detail Pembooking");
